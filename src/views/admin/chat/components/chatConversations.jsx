import { Box, Text, Input, Button, useColorModeValue, Flex, Avatar, Stack, Divider, VStack, IconButton, InputGroup, Kbd } from "@chakra-ui/react";
...
export default function ChatConvertaions(props) {
  ...
  const chatContainerStyle = {
    ...
    height: "calc(100vh -30px)", // Ajustar la altura para llenar todo el espacio (restando el header)
    backgroundColor: useColorModeValue("white", "gray.800"),
    borderRadius: "8px",
    boxShadow: cardShadow,
    padding: "20px",
    overflowY: "auto", // Habilitar el scroll cuando el contenido sea más grande
  };

  const users = [
    { name: "Eduardo Mosquera", online: true, lastMessage: "¡Hola! ¿Cómo estás?", lastMessageDate: '2025-01-15T12:30:00' },
    { name: "Rodolfo Fernando", online: false, lastMessage: "Nos vemos mañana.", lastMessageDate: '2025-01-17T08:00:00' },
    { name: "Cristian Murillo", online: true, lastMessage: "Estoy ocupado, luego te hablo.", lastMessageDate: '2025-01-18T09:15:00' },
    { name: "Fernando Huertado", online: true, lastMessage: "¿Qué tal el trabajo?", lastMessageDate: '2025-01-17T14:45:00' },
    { name: "Juliana Lopez", online: false, lastMessage: "Gracias por la ayuda.", lastMessageDate: '2025-01-16T18:30:00' },
    { name: "Laura Viveros", online: true, lastMessage: "¡Genial!", lastMessageDate: '2025-01-18T11:00:00' },
    { name: "Duban Toro", online: true, lastMessage: "¿Cuándo vamos a comer?", lastMessageDate: '2025-01-15T15:00:00' },
    { name: "Bernardo Casas", online: false, lastMessage: "Revisaré eso después.", lastMessageDate: '2025-01-14T20:30:00' },
    { name: "Sofia Ruiz", online: true, lastMessage: "¡Nos vemos mañana!", lastMessageDate: '2025-01-18T10:00:00' },
    { name: "Carlos Mendoza", online: false, lastMessage: "Hablamos después.", lastMessageDate: '2025-01-13T22:00:00' },
    { name: "Maria Perez", online: true, lastMessage: "Estoy en reunión, te llamo luego.", lastMessageDate: '2025-01-18T13:00:00' },
    { name: "Jorge Hernandez", online: false, lastMessage: "Te mando el reporte más tarde.", lastMessageDate: '2025-01-12T17:30:00' },
    { name: "Paola Sánchez", online: true, lastMessage: "¿Nos reunimos en la tarde?", lastMessageDate: '2025-01-17T15:00:00' },
    { name: "Raul García", online: false, lastMessage: "Voy a descansar un rato.", lastMessageDate: '2025-01-10T09:00:00' },
    { name: "Lina Morales", online: true, lastMessage: "¡Eso suena bien!", lastMessageDate: '2025-01-18T14:45:00' },
    { name: "Andres González", online: false, lastMessage: "Nos ponemos en contacto pronto.", lastMessageDate: '2025-01-09T18:30:00' },
    { name: "Lucia Romero", online: true, lastMessage: "Estoy lista para la reunión.", lastMessageDate: '2025-01-18T16:00:00' },
  ];


  // Mensajes de ejemplo por usuario
  const userMessages = {
    "Eduardo Mosquera": [
    ...
    "Fernando Huertado": [
      ...
      { sender: "Fernando Huertado", text: "Ya, yo también, pero hay que seguir." },
    ],
    "Juliana Lopez": [
      ...
      >
        ...
        >
          ...
          <Flex justify="stretch" align="center" w="100%">
            <Divider borderColor={useColorModeValue("gray.300", "gray.600")} orientation="horizontal" flex="1" />
          </Flex>
        ...
        <Box style={{ height: '80vh', width: '100%', border: '1px solid #ccc', padding: '10px' }} >
              ...
              {messages.map((message, index) => (
                ...
                >
                  ...
                  <Box
                    ...
                    style={message.sender === "user" ? { textAlign: 'right', marginLeft: 'auto', marginRight: 0 } : {}}
                  >
